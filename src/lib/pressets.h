...
#define _PRESSETS_H
		...
		#define CURRENT_MODE_P2H_NORMAL	-3	// Height (meters) to main parachute normal deployment
		#define CURRENT_MODE_P2H_BACKUP	-5	// Height (meters) to main parachute backup deployment
